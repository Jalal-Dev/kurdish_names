...
class KurdishNames {
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'names': names.map((x) => x.toMap()).toList()});
    result.addAll({'recordCount': recordCount});
  ...
  factory KurdishNames.fromJson(String source) => KurdishNames.fromMap(json.decode(source));
...
class Name {
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'nameId': nameId});
    result.addAll({'name': name});
    result.addAll({'desc': desc});
    result.addAll({'gender': gender});
    result.addAll({'positive_votes': positive_votes});
    result.addAll({'negative_votes': negative_votes});
